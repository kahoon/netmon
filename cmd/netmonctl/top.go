...
var topCheckMetaByKey = map[string]topCheckMeta{
	"interface-collection":     {label: "Interface collection", section: "Interface/Addressing", order: 1},
	"interface-oper":           {label: "Interface operational", section: "Interface/Addressing", order: 2},
	"expected-ula":             {label: "Expected ULA", section: "Interface/Addressing", order: 3},
	"usable-gua":               {label: "Usable global IPv6", section: "Interface/Addressing", order: 4},
	"listener-collection":      {label: "Listener collection", section: "DNS", order: 5},
	"dns53-tcp":                {label: "DNS TCP listening", section: "DNS", order: 6},
	"dns53-udp":                {label: "DNS UDP listening", section: "DNS", order: 7},
	"external-dns-v4":          {label: "Upstream DNS IPv4", section: "DNS", order: 8},
	"external-dns-v6":          {label: "Upstream DNS IPv6", section: "DNS", order: 9},
	"resolver5335-tcp":         {label: "Unbound TCP localhost", section: "Unbound", order: 10},
	"resolver5335-udp":         {label: "Unbound UDP localhost", section: "Unbound", order: 11},
