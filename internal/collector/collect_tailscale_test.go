...
func TestTailscaleCollectorCollect(t *testing.T) {
	collector := TailscaleCollector{
		Runner: fakeTailscaleRunner{
			status: []byte(`{
				...
				"HaveNodeKey":true,
				"AuthURL":"",
				"TailscaleIPs":["100.115.43.66","fd7a:115c:a1e0::d33a:2b42"],
				"MagicDNSSuffix":"tailc3ba40.ts.net",
				"CurrentTailnet":{"Name":"kahoonster@gmail.com","MagicDNSSuffix":"tailc3ba40.ts.net"},
				"Self":{"HostName":"caledon","DNSName":"caledon.tailc3ba40.ts.net.","TailscaleIPs":["100.115.43.66","fd7a:115c:a1e0::d33a:2b42"],"Online":true,"Relay":"tor"},
				"Peer":{
					"one":{"Online":true,"Relay":"tor"},
					"two":{"Online":true,"Relay":"tor","Active":true,"CurAddr":"165.227.32.138:59743","InMagicSock":true,"InEngine":true},
	...
	if got, want := state.Addresses.IPv4, "100.115.43.66"; got != want {
