...
func CopySystemState(in SystemState) SystemState {
	return SystemState{
		Interface: InterfaceState{
			...
			CollectionFailure: in.Interface.CollectionFailure,
		},
		Listeners: ListenerState{
			...
			CollectionFailure: in.Listeners.CollectionFailure,
		},
		...
		PiHole: PiHoleState{
			...
			CollectionError:   in.PiHole.CollectionError,
			CollectionFailure: in.PiHole.CollectionFailure,
		},
		Tailscale: TailscaleState{
			...
			CollectionError:   in.Tailscale.CollectionError,
			CollectionFailure: in.Tailscale.CollectionFailure,
		},
	}
}
